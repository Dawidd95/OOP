//1. przyjecie towaru czyli dodaj towar, doda go do magazyn  VVVVVVVVVVVVVVVVVVVVVVVVV zrobione
//2. sprawdz stan magazynu, wyswietlenie wszystkiego w magazynie VVVVVVVVVVVVVVVVVVVVVVVVV zrobione
...
class Magazyn {
	...
	String pokazStan() {
		return this.index+" "+this.nazwa+" "+this.ilosc+" "+this.cena+" zł."; 
	}
}
